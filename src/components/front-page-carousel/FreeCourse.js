          ...
          <Link href="">
			...
			<div className="relative xl:mr-1/6 mb-20">
				<div className="flex justify-end">
					<h1 className="text-white2 text-right text-4xl h-12 cortado w-32">
						<Typewriter
							options={{
								delay: 30,
								cursor: '',
							...
							onInit={(typewriter) => {
								typewriter
									.pauseFor(1000)
									.typeString('<strong >CURSO</strong>')
									.start();
							}}
						/>
					</h1>
				...
				<div className="h-40 text-4xl font-thin tracking-wider text-white2 text-right ">
					<h1 className="mb-2">
						OFERECEMOS UMA AMPLA VARIEDADE
						<br />
						DE CURSOS PARA INICIANTES E<br />
						ESPECIALISTAS QUE VÃO AJUDAR
					</h1>
					<h1 className=" mb-2">
						<span className="bg-golden pl-1 font-medium rounded-full">
					...
					<Typewriter
						...
						onInit={(typewriter) => {
							typewriter
								.pauseFor(1800)
								.typeString(
									'ESTES CURSOS SÃO INTERATIVOS E<br/>'
								)
								.typeString('INCLUEM EXEMPLOS DO MUNDO REAL')
								.start();
						}}
					/>
				</h1>
